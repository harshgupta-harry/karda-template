                            ...
                            <div class="topbar-right">
                                <div class="media">
                                    <div class="media-body">
                                        <?php echo '<a href="tel: '.$headerDetails['contactNumber']['text'].'" class="mobile">'.$headerDetails['contactNumber']['text'].'</a>'; ?>
                                        <?php echo '<a href="mailto: '.$headerDetails['email']['text'].'" class="mobile">'.$headerDetails['email']['text'].'</a>'; ?>
                                    </div>
